class AppAssets {
  ...
  static String deliveryBoy = 'assets/images/delivery_boy.png';
  static String community = 'assets/images/community.png';

  ///icons

  static String doneEmpty = 'assets/icon/done_empty.png';
  static String logo = 'assets/icon/logo.png';
  static String done = 'assets/icon/Done.png';
  static String backArrow = 'assets/icon/back_arrow.png';
  ...
  static String messageIcon = 'assets/icon/message.png';
  static String blueStarFill = 'assets/icon/blue_star_fill.png';
